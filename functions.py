...
def create_page_rectangle_four_picture(list_giving, image):
    screen.fill((255, 255, 255))
    screen.blit(font_default.render("PUZZLE", True, "black"), (350, 50))

    locate_page_rectangle_four_picture(list_giving, image)


def locate_page_rectangle_four_picture(list_giving, image):
...
def color_page_rectangle_four_picture(list_number, list_giving=None, image=None):
    if image is not None and list_giving is not None:
        pygame.draw.rect(screen, (0, 255, 0),
                         pygame.Rect(list_number, 760, 200, 200),  1)
        apper_page_rectangle_four_picture(
...
def apper_page_rectangle_four_picture(list_number, list_giving, image):
